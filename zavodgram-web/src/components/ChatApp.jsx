      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', background: 'rgba(16,19,25,0.86)', backdropFilter: 'blur(24px)' }} className="zg-chatarea">
        {activeChat && acd ? (() => {
          ...
          return (<>
            ...
            {/* Input */}
            <div style={{ borderTop: '1px solid rgba(255,255,255,0.06)', background: 'rgba(15,18,25,0.92)' }}>
              <div style={{ ...s.chatInner, display: 'flex', flexDirection: 'column', gap: 8, padding: '10px 14px' }}>
