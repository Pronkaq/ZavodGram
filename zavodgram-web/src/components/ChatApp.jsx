...
const s = {
  ...
  ib: { background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.28)', color: '#DCE0E8', cursor: 'pointer', padding: 6, borderRadius: 10, display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', backdropFilter: 'blur(20px)' },
  ...
  inp2: { flex: 1, width: '100%', background: 'rgba(255,255,255,0.7)', border: '1px solid rgba(255,255,255,0.3)', borderRadius: 12, padding: '10px 14px', color: '#11151d', fontSize: 14, fontFamily: "'Manrope', sans-serif", outline: 'none', backdropFilter: 'blur(22px)', boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.6), inset 0 -8px 20px rgba(0,0,0,0.08)' },
  saveBtn: { padding: '10px 16px', background: 'rgba(255,255,255,0.78)', border: '1px solid rgba(255,255,255,0.34)', borderRadius: 10, color: '#161b24', fontSize: 13, fontWeight: 700, cursor: 'pointer', whiteSpace: 'nowrap', backdropFilter: 'blur(22px)', boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.72), 0 10px 24px rgba(0,0,0,0.22)' },
  sendBtn: { width: 40, height: 40, borderRadius: 12, background: 'rgba(255,255,255,0.8)', border: '1px solid rgba(255,255,255,0.35)', color: '#141923', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, backdropFilter: 'blur(22px)', boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.72), 0 10px 22px rgba(0,0,0,0.22)' },
};
