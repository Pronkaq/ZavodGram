  ...
  return (
    <div className="zg-shell" style={s.root} onClick={() => { setContextMenu(null); setSidebarOpen(false); setAttachMenu(false); setNotifPanel(false); setReactionPicker(null); }}>
      ...
      {profilePanel && profileData && (
        <div style={{ position: 'absolute', top: 8, right: 8, bottom: 8, width: 340, maxWidth: '100vw', background: 'rgba(12,15,22,0.94)', borderLeft: '1px solid rgba(255,255,255,0.06)', borderRadius: 20, zIndex: 90, display: 'flex', flexDirection: 'column', overflowY: 'auto', backdropFilter: 'blur(16px)' }} onClick={e => e.stopPropagation()}>
